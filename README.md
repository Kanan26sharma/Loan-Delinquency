...
Cleaned Data: 9,489 records after removing 89 unrealistic records and duplicates. After removing 89 records with unrealistic debt-to-income values, the final working dataset contained 9,489 clean records with a class distribution of approximately 84% non-delinquent and 16% delinquent borrowers.
...
High Risk	>55%	26.7%
High Risk borrowers are nearly 5 times more likely to default than Low Risk. Risk Tiers Visualiz.

8. Key Risk Drivers
FICO Score - higher score lowers risk
Recent Credit Inquiries - more inquiries increase risk
Loan Interest Rate - higher rate increases risk
Annual Income - higher income lowers risk
Payment Size - larger payments increase strain
...
Minimum FICO ≥ 700 for small business loans
Flag borrowers with ≥ 2 past-due events for monitoring
Adjust interest rates or loan amounts for borderline applicants
Automate pre-approval for Low Risk borrowers (<30% probability)
11. Summary
